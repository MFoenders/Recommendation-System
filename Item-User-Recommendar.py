...
st.write('Take a look at the recommendations below, which are derived from shared movie interests or may provide inspiration from other users')
...
def n_predictions_for_user(testset, user_input, n):
    ...
    final = merged_df[['title', 'genres', 'rating (estimated)']]
    return final
